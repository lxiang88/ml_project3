...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        hidden_layer_activation = self.applyrelu(hidden_layer_weighted_input)
        # TODO (3 by 1 matrix)
        ...
        # print(self.hidden_to_output_weights.T,'self.hidden_to_output_weights.T')
        # print(output_layer_error, 'output_layer_error')
        # print(self.applyrelu_deriv(hidden_layer_activation), 'self.applyrelu_deriv(hidden_layer_activation)')
        hidden_layer_error = np.multiply(self.hidden_to_output_weights.T * output_layer_error,
                                         self.applyrelu_deriv(hidden_layer_activation))
        # hidden_layer_error = np.multiply(self.hidden_to_output_weights.T*output_layer_error,rectified_linear_unit_derivative(output))
        # 3 by 1
        # print(np.multiply(self.hidden_to_output_weights.T*output_layer_error,self.applyrelu_deriv(hidden_layer_activation)),'np.multiply(self.hidden_to_output_weights.T*output_layer_error,self.applyrelu_deriv(hidden_layer_activation)')
        # print(self.hidden_to_output_weights.T*output_layer_error,'self.hidden_to_output_weights.T*output_layer_error')
        # print(hidden_layer_error ,'hidden_layer_error ')
        bias_gradients = hidden_layer_error
        hidden_to_output_weight_gradients = np.transpose(output_layer_error*hidden_layer_activation.T)
        ...
        # print(self.input_to_hidden_weights, 'self.input_to_hidden_weights')
        self.hidden_to_output_weights -= self.learning_rate*hidden_to_output_weight_gradients.T
        # print(self.hidden_to_output_weights,'self.hidden_to_output_weights')
